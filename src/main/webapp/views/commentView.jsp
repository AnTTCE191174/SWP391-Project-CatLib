                            ...
                            <div class="flex-1">
                                ...
                                <c:if test="${loginedUser.role == 'admin'}">
                                    <div class="mt-2 text-right"> 
                                        <a href="${pageContext.request.contextPath}/admin/delete-comment?commentId=${comment.id}&bookId=${book.bookId}"
                                           class="text-red-500 hover:text-red-700 text-sm font-semibold"
                                           onclick="return confirm('Bạn có chắc chắn muốn xoá bình luận này không?');">
                                            Delete
                                        </a>
                                    </div>
                                </c:if>
